package com.salesmanager.core.business.modules.cms.content.digitalocean;
 ...
 *
 */
public class DOSpaceContentAssetsManagerImpl implements ContentAssetsManager {

	private static final long serialVersionUID = 1L;

	private static final Logger LOGGER = LoggerFactory.getLogger(DOSpaceContentAssetsManagerImpl.class);
	...
	public static DOSpaceContentAssetsManagerImpl getInstance() {
		...
		if (fileManager == null) {
			fileManager = new DOSpaceContentAssetsManagerImpl();
		}
