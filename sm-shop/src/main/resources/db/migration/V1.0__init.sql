...
CREATE TABLE `category_image` (
  ...
  KEY `FKiwkgnvkgkrdb5qgkoxksoc5mf` (`CATEGORY_ID`),
  CONSTRAINT `FKiwkgnvkgkrdb5qgkoxksoc5mf` FOREIGN KEY (`CATEGORY_ID`) REFERENCES `category` (`CATEGORY_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-10-22  1:47:12
